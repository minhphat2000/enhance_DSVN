...
def main(_argv):
    ...
    """ init. Webcam object 
    """
    vid = cv2.VideoCapture('video lỗi - Made with Clipchamp_1701924278680.mp4')

    
    #zvid  = cv2.VideoCapture(0)   
    ...
    nn_budget = None
    nms_max_overlap = 1.0
    # max_cosine_distance = 0.2  # Giảm giá trị để làm mô hình nhạy hơn với các đối tượng giống nhau
    # nn_budget = 100  # Đặt một giá trị cụ thể cho nn_budget để giảm bộ nhớ cần thiết
    # nms_max_overlap = 0.8  # Giảm giá trị để giữ lại các bounding boxes có độ chồng lấn lớn hơn
