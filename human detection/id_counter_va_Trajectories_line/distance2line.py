...
def estimate_person_height(camera_indices=[0], known_distance=2.0, known_height=1.7, stationary_threshold=10, custom_distance=100):
    # Model
    ...
    # Chỉ số cách biệt giữa hai đường (khoảng cách tùy chỉnh)
    in_line_start_x = middle_x - custom_distance
    out_line_start_x = middle_x + custom_distance

    in_line = (in_line_start_x, 0)
    out_line = (out_line_start_x, 0)
...
if __name__ == "__main__":
    ...
    estimate_person_height(camera_indices=[0, 1], custom_distance=10)
